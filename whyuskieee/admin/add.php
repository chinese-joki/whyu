...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO announcements (title, content, date_created, status) VALUES (?, ?, ?, ?)");
            if ($stmt->execute([$title, $content, $date, $status])) {
            ...
            $error = 'Gagal menambahkan pengumuman. Silakan coba lagi.';
        }
    }
}
?>
...
<head>
    ...
    <title>Tambah Pengumuman - Whyuskieee Admin</title>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" required>
                            <option value="biasa" <?php echo ($status ?? '') === 'biasa' ? 'selected' : ''; ?>>
                                📄 Biasa
                            </option>
                            <option value="penting" <?php echo ($status ?? '') === 'penting' ? 'selected' : ''; ?>>
                                🔥 Penting
                            </option>
                        </select>
                    </div>
